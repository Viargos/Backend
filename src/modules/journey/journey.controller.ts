...
export class JourneyController {
  ...
  @ApiResponse({ status: 201, description: 'Journey created successfully', type: Journey })
  create(@Request() req, @Body() createJourneyDto: CreateJourneyDto): Promise<Journey> {
  ...
  @ApiResponse({ status: 200, description: 'Journeys retrieved successfully', type: [Journey] })
  ...
  @ApiResponse({ status: 200, description: 'Journey retrieved successfully', type: Journey })
  ...
  @ApiResponse({ status: 200, description: 'Journey updated successfully', type: Journey })
  update(@Param('id') id: string, @Body() updateJourneyDto: CreateJourneyDto): Promise<Journey> {
