...
export class DashboardController {
  ...
  @ApiOperation({ 
    ...
    description: 'Fetches posts for dashboard with pagination support. Use cursor for infinite scroll. Perfect for mobile apps with scroll-to-load-more functionality.' 
  })
  @ApiResponse({
    status: 200,
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              description: { type: 'string', example: 'Amazing sunset at the beach!' },
              ...
              longitude: { type: 'number', example: 115.0920 },
            ...
            hasMore: { type: 'boolean', example: true, description: 'Whether there are more posts to load' },
            nextCursor: { type: 'string', example: 'uuid-string', description: 'Use this cursor for the next request to load more posts' },
            totalCount: { type: 'number', example: 150, description: 'Total count (only provided on first request without cursor)' }
          }
        }
      }
  })
